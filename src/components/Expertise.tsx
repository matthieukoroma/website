            ...
            <div className="skills-grid">
                <div className="skill">
                    ...
                    <p>
                        ...
                        J'utilise l'analyse conceptuelle et les connaissances bibliographiques pour établir un paradigme qui répond à une question de recherche.
                    </p>
                </div>
                ...
                <div className="skill">
                    ...
                    <p>
                        ...
                        J'évalue la pertinence et les champs d'application d'un paradigme pour structurer une stratégie qui assure un financement de recherche.
                    </p>
                </div>
